...
namespace PublicApi.DTO.v1.MappingProfiles
{
    public class AutoMapperProfile: Profile
    {
        public AutoMapperProfile()
        {
            ...
            CreateMap<BLL.App.DTO.League, League>().ReverseMap();
            CreateMap<BLL.App.DTO.LeagueTeam, LeagueTeam>().ReverseMap();
            ...
            CreateMap<BLL.App.DTO.LeagueTableClient, LeagueTableClient>().ReverseMap();
        }
    }
}